...
class GoogleResultTest {
  ...
  void test_asBook() {
    GoogleResult bookJson = new GoogleResult(1,
        new GoogleResult.GoogleBook[] {
            new GoogleResult.GoogleBook(new GoogleResult.GoogleBook.VolumeInfo("Jane Eyre",
                new String[] {"Charlotte Brontë"}, "2007", "Description",
  ...
  void test_asBook_missingIsbn13() {
    GoogleResult bookJson = new GoogleResult(1,
        new GoogleResult.GoogleBook[] {
            new GoogleResult.GoogleBook(new GoogleResult.GoogleBook.VolumeInfo(
                "The Hound of the Baskervilles", new String[] {"Arthur Conan Doyle"}, "1902",
                "A gripping tale of mystery and danger.",
                new GoogleResult.Identifier[] {new GoogleResult.Identifier("ISBN_10", "11111")}, // Only
                                                                                                 // ISBN_10
  ...
  void test_asBook_missingPublishedDate() {
    GoogleResult bookJson = new GoogleResult(1,
        new GoogleResult.GoogleBook[] {
            new GoogleResult.GoogleBook(new GoogleResult.GoogleBook.VolumeInfo(
                "The Hound of the Baskervilles", new String[] {"Arthur Conan Doyle"}, null, // Missing
                                                                                            // publishedDate
                "A gripping tale of mystery and danger.",
                new GoogleResult.Identifier[] {new GoogleResult.Identifier("ISBN_13", "12345")},
                new GoogleResult.ImageLinks("https://example.com/hound.jpg")))});
  ...
  void test_asBook_missingDescription() {
    GoogleResult bookJson =
        new GoogleResult(1,
            new GoogleResult.GoogleBook[] {new GoogleResult.GoogleBook(
                new GoogleResult.GoogleBook.VolumeInfo("The Hound of the Baskervilles",
                    new String[] {"Arthur Conan Doyle"}, "1902", null, // Missing description
                    new GoogleResult.Identifier[] {new GoogleResult.Identifier("ISBN_13", "12345")},
                    new GoogleResult.ImageLinks("https://example.com/hound.jpg")))});
    ...
    assertAll(() -> assertEquals("12345", result.getIsbn()),
        ...
        () -> assertEquals("No description provided", result.getDescription()) // Default
                                                                               // description
    );
  }
  ...
  void test_asBook_missingThumbnail() {
    GoogleResult bookJson = new GoogleResult(1, new GoogleResult.GoogleBook[] {
        new GoogleResult.GoogleBook(new GoogleResult.GoogleBook.VolumeInfo(
            "The Hound of the Baskervilles", new String[] {"Arthur Conan Doyle"}, "1902",
            "A gripping tale of mystery and danger.",
            new GoogleResult.Identifier[] {new GoogleResult.Identifier("ISBN_13", "12345")}, null // Missing
                                                                                                  // imageLinks
        ))});
    ...
    assertAll(() -> assertEquals("12345", result.getIsbn()),
        ...
        () -> assertEquals("1902", result.getPublishedYear()),
        () -> assertEquals(
            "https://images.squarespace-cdn.com/content/v1/5add0dce697a985bcc001d2c/1524679485048-OS856WANHVR26WPONXPI/004.JPG",
            result.getThumbnail()), // Default thumbnail
