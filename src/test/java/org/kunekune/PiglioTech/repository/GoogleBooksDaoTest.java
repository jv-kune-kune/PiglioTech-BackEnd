...
public class GoogleBooksDaoTest {
  ...
  public void test_fetchBookByIsbn() throws Exception {
    ...
    mockWebServer.enqueue(new MockResponse().setBody(TestStrings.SingleBookJsonResponse)
  ...
  public void test_fetchBookByIsbn_notFound() throws Exception {
    ...
    mockWebServer.enqueue(new MockResponse().setBody(TestStrings.NoBooksJsonResponse)
        .addHeader("Content-Type", "application/json"));

    assertThrows(NoSuchElementException.class,
        () -> googleBooksDAO.fetchBookByIsbn("9780099511120"));
  }
  ...
  public void test_fetchBookByIsbn_apiTimeout() throws Exception {
    mockWebServer.enqueue(new MockResponse().setResponseCode(504) // Gateway Timeout
        .setBody("{\"error\": \"Timeout\"}").addHeader("Content-Type", "application/json"));
  ...
  public void test_fetchBookByIsbn_partialResponse() throws Exception {
    ...
    mockWebServer.enqueue(new MockResponse().setBody(TestStrings.NoAuthorsResponse)
        .addHeader("Content-Type", "application/json"));

    mockWebServer.enqueue(new MockResponse().setBody(TestStrings.NoTitleResponse)
        .addHeader("Content-Type", "application/json"));
